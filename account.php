                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form class="needs-validation" action="account.php" method="post" novalidate="">

                                                <div class="mb-3">
                                                    <label for="name">First Name</label>
                                                    <div class="input-group">
                                                    <input type="text" class="form-control" name="first" style="width: 100%">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="name">Last Name</label>
                                                    <div class="input-group">
                                                    <input type="text" class="form-control" name="last" style="width: 100%">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="numbers">Number</label>
                                                    <div class="input-group">
                                                    <input type="numbers" class="form-control" name="number" style="width: 100%">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="numbers">Address</label>
                                                    <div class="input-group">
