...
if(isset($_POST['submit'])){
    ...
    while(($fileop = fgetcsv($handle,1000,",")) !==false)
    {
        ...
        $sql = "INSERT INTO contact (uid, number,name) VALUES ( '$userid','$number', '$name');";
        $result = mysqli_query($conn , $sql);
        $sql1 = "INSERT INTO sendsms (uid,number, sms_body, status) VALUES ('$userid','$number', '$message' ,'$status');";
    ...
    if ($result==1) {
            ...
            echo "<script> alert ('Data Uploaded And Message Sent') </script>";
                    echo "<script>window.open('inbox.php','_self')</script>";
                    exit();
        }else{

            echo "<script> alert ('Data upload failed') </script>";
                    echo "<script>window.open('dynamic-sms.php','_self')</script>";
                    exit();
        }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Dynamic SMS</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="mb-0">Dynamic SMS</h4>
                                        </div>
                                        <div class="card-body">
                                            <form action="dynamic-sms.php" method="post" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    <label for="message">Upload numbers</label>
                                                ...
                                                <hr class="mb-4">
                                                <input type="submit" name="submit" class="btn btn-primary btn-pill" value="Upload and Send Messages">
                                            </form>
                                        </div>
                                    </div>
                                </div>
