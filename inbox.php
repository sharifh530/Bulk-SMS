...
session_start();
    ...
    $sendsms=mysqli_query($conn,"select * from sendsms");

    if(isset($_GET['delete'])){
    $id=$_GET['delete'];

    $sql = "DELETE FROM `sendsms` WHERE `sendsms`.`id` = $id";
...
<body>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0 th1">ID</th>
                                                        <th class="border-0 th2">To</th>
                                                        <th class="border-0 th3">Message</th>
                                                        <th class="border-0 th3">Status</th>
                                                        <th class="border-0 th4">Delete</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
    <?php 
    ...
    <tr>
        ...
        <td ><?php echo $sendsms['id'];?></td>
        <td><?php echo $sendsms['number']; ?></td>
        <td><?php echo $sendsms['sms_body']; ?></td>
        <td><?php echo $sendsms['status']; ?></td>
        <th><a href="inbox.php?delete= <?php echo $sendsms['id']; ?>" class="btn btn-danger" >Delete</a></th>
