...
if(isset($_GET['delete'])){
    ...
    if ($result==1) {
            ...
            echo "<script> alert ('Contact Could Not Deleted') </script>";
                    echo "<script>window.open('manage-contact.php','_self')</script>";
                    exit();
        }
}
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Manage Contact</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Delete Contact</th>
                                                        <th class="border-0">Send SMS</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
    <?php 
    ...
    <tr>
        ...
        <th><a href="manage-contact.php?delete= <?php echo $contact['id']; ?>" class="btn btn-danger" >Delete</a></th>
        <th><a href="normal-sms.php?sendsms= <?php echo $contact['id']; ?>" class="btn btn-primary btn-pill" >Send SMS</a></th>
