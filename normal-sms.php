...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO sendsms (uid, number, sms_body, status) VALUES ('$uid','$number', '$message' ,'$status');";
    ...
    if ($result==1) {
            ...
            echo "<script> alert ('Error Occured') </script>";
                    echo "<script>window.open('normal-sms.php','_self')</script>";
                    exit();
        }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Normal SMS</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="mb-0">Normal SMS</h4>
                                        </div>
                                        <div class="card-body">
                                            <form class="needs-validation" action="normal-sms.php" method="post" >
                                                <div class="mb-3">
                                                    <label for="numbers">Number</label>
                                                    <div class="input-group">
                                                        <input type="text" name="number" placeholder="Write Appropiate Number" value ="<?php echo $number; ?>" class="form-control" style="width: 100%"></textarea>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="message">Message</label>
                                                    <div class="input-group">
                                                        <textarea id="message" name="message" placeholder="Write your message here" style="width: 100%"></textarea>
                                                    </div>
                                                </div>
                                                <hr class="mb-4">
                                                <input type="submit" name="submit" class="btn btn-primary btn-pill" value="Send SMS">
                                            </form>
                                        </div>
                                    </div>
                                </div>
