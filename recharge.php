                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Recharge</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="mb-0">BKash Merchant Number: 01748-000347</h4>
                                        </div>
                                        <div class="card-body">
                                            <form class="needs-validation" novalidate="">
                                                <div class="mb-3">
                                                    <label for="numbers">Bkash Transaction ID</label>
                                                    <div class="input-group">
                                                    <input type="numbers" class="form-control" name="numbers" style="width: 100%">
                                                    </div>
                                                </div>
                                                <hr class="mb-4">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2019 Concept. All rights reserved. In part with Rokomari.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
